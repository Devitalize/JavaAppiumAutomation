...
public class SearchPageObject extends MainPageObject {
    ...
    public void initSearchInput() {
        ...
        this.waitForElementPresent(By.xpath(SEARCH_INIT_ELEMENT), "Cannot find search input after clicking search input element", 5);
    }
    ...
    public void assertThereIsNoResultOfSearch(){
        this.assertElementsNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "We supposed not find any results");
    }
}
